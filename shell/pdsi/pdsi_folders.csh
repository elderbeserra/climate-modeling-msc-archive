#!/bin/csh -x
# ============================================================================
# Script: pdsi_folders.csh
# Purpose: Create and populate PDSI folder structure for present scenario.
...
'sdfopen ${DATA_ROOT}/obs_proclima/cad/arm_cad.nc'
'sdfopen ${DATA_ROOT}/agcm20/Brazil/present/annual/maskTL959.nc'
'c'                                              
*
'define mask = lterp(ratiol.2(t=1,z=1),ta)'
'set t 1 last'
'define cad = lterp(arm_cad.3(z=1),ta)'
'define cad20 = regrid2(cad,0.2)'
'define cad20m = cad20/mask'
*
pathh='${DATA_ROOT}/agcm20/Brazil/present/PDSI'
*
'set t 1'
'set x '${xx}
'set y '${yy}
'define cadmed = ave(cad20m,t=1,t=4018)'
...
cad=subwrd(result,4)
variavelcad=cad%" "%la
rec=write(pathh'/'${xx}'_'${yy}'/monthly_T',variaveltm,append)
*
...
rec=write(pathh'/'${xx}'_'${yy}'/monthly_P',variavelpm,append)
*
count=count+12
endwhile
...
rec=write(pathh'/'${xx}'_'${yy}'/mon_T_normal',variavelt)
...
rec=write(pathh'/'${xx}'_'${yy}'/mon_P_normal',variavelp)
*
'quit'
*************************************
*   
